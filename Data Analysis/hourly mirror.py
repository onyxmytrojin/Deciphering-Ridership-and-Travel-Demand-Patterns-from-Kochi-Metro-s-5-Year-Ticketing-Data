...
ax1.bar(br1,hourly_data_weekday,label='Weekday Origin',width=barWidth,color='b')
ax2.bar(br1,hourly_data_weekend,label='Weekend Origin',width=barWidth,color='b')
plt.legend()
...
ax1.bar(br2,hourly_data_weekday,label='Weekday Destination',width=barWidth,color='r')
ax2.bar(br2,hourly_data_weekend,label='Weekend Destination',width=barWidth,color='r')
